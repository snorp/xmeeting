...
- (id)_init
{
  ...
  sipAccounts = nil;
  locations = nil;
  passwordObjects = [[NSMutableArray alloc] initWithCapacity:10];
...
- (void)setSIPAccounts:(NSArray *)accounts
{
  ...
  [self _resetPasswords:XMPasswordObjectType_SIPAccount];
}
...
- (void)setLocations:(NSArray *)newLocations
{
  ...
  [self _resetPasswords:XMPasswordObjectType_SIPProxyPassword];
...
- (void)addPasswordObject:(id<XMPasswordObject>)obj
{
  [passwordObjects addObject:obj];
}

- (void)removePasswordObject:(id<XMPasswordObject>)obj
{
  [passwordObjects removeObject:obj];
}
