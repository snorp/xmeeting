...
void _XMCallRecorderPixelBufferReleaseCallback(void *releaseRefCon, const void *baseAddress);

void _XMZeroFillLocalAudio(void *buffer, unsigned frameOffset, unsigned bytesPerFrame);
void _XMZeroFillLocalAudio16Bit(void *buffer, unsigned frameOffset);
void _XMZeroFillLocalAudio8Bit(void *buffer, unsigned frameOffset);
void _XMZeroFillRemoteAudio(void *buffer, unsigned frameOffset, unsigned bytesPerFrame);
void _XMZeroFillRemoteAudio16Bit(void *buffer, unsigned frameOffset);
void _XMZeroFillRemoteAudio8Bit(void *buffer, unsigned frameOffset);
void _XMZeroAddLocalAudio(void *buffer, unsigned offset, unsigned numberOfZeros, unsigned bytesPerFrame);
void _XMZeroAddLocalAudio16Bit(void *buffer, unsigned offset, unsigned numberOfZeros);
void _XMZeroAddLocalAudio8Bit(void *buffer, unsigned offset, unsigned numberOfZeros);
void _XMZeroAddRemoteAudio(void *buffer, unsigned offset, unsigned numberOfZeros, unsigned bytesPerFrame);
void _XMZeroAddRemoteAudio16Bit(void *buffer, unsigned offset, unsigned numberOfZeros);
void _XMZeroAddRemoteAudio8Bit(void *buffer, unsigned offset, unsigned numberOfZeros);
void _XMDataAddLocalAudio(void *dstBuffer, unsigned offset, void *srcBuffer, unsigned numberOfFrames, XMCodecIdentifier codecIdentifier);
void _XMDataAddLocalAudioLPCM(void *dstBuffer, unsigned offset, void *srcBuffer, unsigned numberOfFrames);
void _XMDataAddLocalAudioULAW(void *dstBuffer, unsigned offset, void *srcBuffer, unsigned numberOfFrames);
void _XMDataAddLocalAudioALAW(void *dstBuffer, unsigned offset, void *srcBuffer, unsigned numberOfFrames);
void _XMDataAddRemoteAudio(void *dstBuffer, unsigned offset, void *srcBuffer, unsigned numberOfFrames, XMCodecIdentifier codecIdentifier);
void _XMDataAddRemoteAudioLPCM(void *dstBuffer, unsigned offset, void *srcBuffer, unsigned numberOfFrames);
void _XMDataAddRemoteAudioULAW(void *dstBuffer, unsigned offset, void *srcBuffer, unsigned numberOfFrames);
void _XMDataAddRemoteAudioALAW(void *dstBuffer, unsigned offset, void *srcBuffer, unsigned numberOfFrames);
...
- (void)_handleUncompressedLocalVideoFrame:(CVPixelBufferRef)pixelBuffer
{
  ...
  if (recompressionBuffer != NULL && recordLocalVideo == YES) {
    if (frameOccupied == NO) {
      ...
      for (unsigned i = 0; i < srcHeight; i++) {
