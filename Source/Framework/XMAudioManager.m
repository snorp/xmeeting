/*
 * $Id: XMAudioManager.m,v 1.15 2009/01/11 18:58:26 hfriederich Exp $
 *
...
OSStatus XMAudioManagerDeviceListPropertyListenerProc(AudioHardwarePropertyID inPropertyID,
                                                      void *inClientData)
{
  [[XMAudioManager sharedInstance] performSelectorOnMainThread:@selector(updateDeviceLists) withObject:nil waitUntilDone:NO];
  return noErr;
}
...
{    
  if (isInput) {
    [[XMAudioManager sharedInstance] performSelectorOnMainThread:@selector(_inputVolumeDidChange) withObject:nil waitUntilDone:NO];
  } else {
    [[XMAudioManager sharedInstance] performSelectorOnMainThread:@selector(_outputVolumeDidChange) withObject:nil waitUntilDone:NO];
  }
