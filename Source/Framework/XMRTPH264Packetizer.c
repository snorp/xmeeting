...
ComponentResult XMRTPH264Packetizer_Close(XMRTPH264PacketizerGlobals globals, ComponentInstance self)
{
  if (globals) {
    free(globals);
  }
...
ComponentResult XMRTPH264Packetizer_Target(XMRTPH264PacketizerGlobals globals, ComponentInstance target)
{
...
ComponentResult XMRTPH264Packetizer_Initialize(XMRTPH264PacketizerGlobals globals, SInt32 inFlags)
{
  if ((inFlags & 2) != 0) {
...
ComponentResult XMRTPH264Packetizer_Idle(XMRTPH264PacketizerGlobals globals, SInt32 inFlags, SInt32 *outFlags)
{
  *outFlags = 0;
  return noErr;
}
...
ComponentResult XMRTPH264Packetizer_Flush(XMRTPH264PacketizerGlobals globals, SInt32 inFlags, SInt32 *outFlags)
{
  *outFlags = 0;
  return noErr;
}

ComponentResult XMRTPH264Packetizer_Reset(XMRTPH264PacketizerGlobals globals, SInt32 inFlags)
{
  return noErr;
}

ComponentResult XMRTPH264Packetizer_SetInfo(XMRTPH264PacketizerGlobals globals, OSType inSelector, const void *ioParams)
{
  printf("SetInfo called\n");
  return paramErr;
}

ComponentResult XMRTPH264Packetizer_GetInfo(XMRTPH264PacketizerGlobals globals, OSType inSelector, void *ioParams)
{
  printf("GetInfo called\n");
  return paramErr;
}

ComponentResult XMRTPH264Packetizer_SetTimeScale(XMRTPH264PacketizerGlobals globals, TimeScale inTimeScale)
{   
  globals->timeScale = inTimeScale;
  return noErr;
}

ComponentResult XMRTPH264Packetizer_GetTimeScale(XMRTPH264PacketizerGlobals globals, TimeScale *outTimeScale)
{
  *outTimeScale = globals->timeScale;
  return noErr;
}

ComponentResult XMRTPH264Packetizer_SetTimeBase(XMRTPH264PacketizerGlobals globals, TimeBase inTimeBase)
{
  globals->timeBase = inTimeBase;
  return noErr;
}

ComponentResult XMRTPH264Packetizer_GetTimeBase(XMRTPH264PacketizerGlobals globals, TimeBase *outTimeBase)
{
  *outTimeBase = globals->timeBase;
  return noErr;
}

ComponentResult XMRTPH264Packetizer_HasCharacteristic(XMRTPH264PacketizerGlobals globals, OSType inSelector, Boolean *outHasIt)
{
  printf("HasCharacteristic called\n");
  return paramErr;
}

ComponentResult XMRTPH264Packetizer_SetPacketBuilder(XMRTPH264PacketizerGlobals globals, ComponentInstance inPacketBuilder)
{
  globals->packetBuilder = inPacketBuilder;
  return noErr;
}

ComponentResult XMRTPH264Packetizer_GetPacketBuilder(XMRTPH264PacketizerGlobals globals, ComponentInstance *outPacketBuilder)
{
  *outPacketBuilder = globals->packetBuilder;
  return noErr;
}

ComponentResult XMRTPH264Packetizer_SetMediaType(XMRTPH264PacketizerGlobals globals, OSType inMediaType)
{
  if (inMediaType != 'avc1') {
    return paramErr;
  }
...
ComponentResult XMRTPH264Packetizer_GetMediaType(XMRTPH264PacketizerGlobals globals, OSType *outMediaType)
{
  *outMediaType = 'avc1';
  return noErr;
}
...
ComponentResult XMRTPH264Packetizer_SetMaxPacketDuration(XMRTPH264PacketizerGlobals globals, UInt32 inMaxPacketDuration)
{
  printf("SetMaxPacketDuration called\n");
  return paramErr;
}

ComponentResult XMRTPH264Packetizer_GetMaxPacketDuration(XMRTPH264PacketizerGlobals globals, UInt32 *outMaxPacketDuration)
{
  printf("GetMaxPacketDuration called\n");
  return paramErr;
}

ComponentResult XMRTPH264Packetizer_DoUserDialog(XMRTPH264PacketizerGlobals globals, ModalFilterUPP inFilterUPP, Boolean *canceled)
{
...
ComponentResult XMRTPH264Packetizer_GetSettingsAsText(XMRTPH264PacketizerGlobals globals, Handle *text)
{
 ...
 * This function registers the XMRTPH264Packetizer component so that
 * this component can be used as a media packetizer for RFC3984 compliant
 * H.264
 **/
...
{	
  ...
  // Registering the Component
  ComponentRoutineUPP componentEntryPoint = NewComponentRoutineUPP((ComponentRoutineProcPtr)&XMRTPH264Packetizer_ComponentDispatch);
