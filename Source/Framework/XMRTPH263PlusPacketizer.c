/*
 * $Id: XMRTPH263PlusPacketizer.c,v 1.3 2006/05/17 11:48:38 hfriederich Exp $
 *
...
ComponentResult XMRTPH263PlusPacketizer_Open(XMRTPH263PlusPacketizerGlobals globals,
											 ComponentInstance self)
{
...
ComponentResult XMRTPH263PlusPacketizer_Close(XMRTPH263PlusPacketizerGlobals globals,
											  ComponentInstance self)
{
	if(globals)
	{
...
ComponentResult XMRTPH263PlusPacketizer_Target(XMRTPH263PlusPacketizerGlobals globals,
											   ComponentInstance target)
{
...
ComponentResult XMRTPH263PlusPacketizer_Initialize(XMRTPH263PlusPacketizerGlobals globals,
												   SInt32 inFlags)
{
	return noErr;
}
...
ComponentResult XMRTPH263PlusPacketizer_Idle(XMRTPH263PlusPacketizerGlobals globals,
											 SInt32 inFlags,
											 SInt32 *outFlags)
{
	*outFlags = 0;
...
ComponentResult XMRTPH263PlusPacketizer_Flush(XMRTPH263PlusPacketizerGlobals globals,
											  SInt32 inFlags,
											  SInt32 *outFlags)
{
	*outFlags = 0;
...
ComponentResult XMRTPH263PlusPacketizer_Reset(XMRTPH263PlusPacketizerGlobals globals,
											  SInt32 inFlags)
{
	return noErr;
}

ComponentResult XMRTPH263PlusPacketizer_SetInfo(XMRTPH263PlusPacketizerGlobals globals,
												OSType inSelector,
												const void *ioParams)
{
...
ComponentResult XMRTPH263PlusPacketizer_GetInfo(XMRTPH263PlusPacketizerGlobals globals,
												OSType inSelector,
												void *ioParams)
{
...
ComponentResult XMRTPH263PlusPacketizer_SetTimeScale(XMRTPH263PlusPacketizerGlobals globals,
...
ComponentResult XMRTPH263PlusPacketizer_GetTimeScale(XMRTPH263PlusPacketizerGlobals globals,
...
ComponentResult XMRTPH263PlusPacketizer_SetTimeBase(XMRTPH263PlusPacketizerGlobals globals,
													TimeBase inTimeBase)
{
...
ComponentResult XMRTPH263PlusPacketizer_GetTimeBase(XMRTPH263PlusPacketizerGlobals globals,
...
ComponentResult XMRTPH263PlusPacketizer_HasCharacteristic(XMRTPH263PlusPacketizerGlobals globals,
														  OSType inSelector,
														  Boolean *outHasIt)
{
...
ComponentResult XMRTPH263PlusPacketizer_SetPacketBuilder(XMRTPH263PlusPacketizerGlobals globals,
...
ComponentResult XMRTPH263PlusPacketizer_GetPacketBuilder(XMRTPH263PlusPacketizerGlobals globals,
...
ComponentResult XMRTPH263PlusPacketizer_SetMediaType(XMRTPH263PlusPacketizerGlobals globals,
													 OSType inMediaType)
{
	if(inMediaType != '+263')
	{
...
ComponentResult XMRTPH263PlusPacketizer_GetMediaType(XMRTPH263PlusPacketizerGlobals globals,
													 OSType *outMediaType)
{
	*outMediaType = '+263';
	return noErr;
...
ComponentResult XMRTPH263PlusPacketizer_SetMaxPacketSize(XMRTPH263PlusPacketizerGlobals globals,
...
ComponentResult XMRTPH263PlusPacketizer_GetMaxPacketSize(XMRTPH263PlusPacketizerGlobals globals,
...
ComponentResult XMRTPH263PlusPacketizer_SetMaxPacketDuration(XMRTPH263PlusPacketizerGlobals globals,
...
ComponentResult XMRTPH263PlusPacketizer_GetMaxPacketDuration(XMRTPH263PlusPacketizerGlobals globals,
...
ComponentResult XMRTPH263PlusPacketizer_DoUserDialog(XMRTPH263PlusPacketizerGlobals globals,
...
ComponentResult XMRTPH263PlusPacketizer_GetSettingsAsText(XMRTPH263PlusPacketizerGlobals globals,
														  Handle *text)
{
...
{	
	...
	ComponentRoutineUPP componentEntryPoint =
		NewComponentRoutineUPP((ComponentRoutineProcPtr)&XMRTPH263PlusPacketizer_ComponentDispatch);
