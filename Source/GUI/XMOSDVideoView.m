/*
 * $Id: XMOSDVideoView.m,v 1.19 2008/11/03 21:34:03 hfriederich Exp $
 *
...
- (NSString *)settings
{
  return [NSString stringWithFormat:@"%d %f %f", [self pinpMode],
...
- (void)setSettings:(NSString *)settings
{
  ...
  if ([scanner scanInt:&mode] && [scanner scanFloat:&x] && [scanner scanFloat:&y] && [scanner isAtEnd]) {
